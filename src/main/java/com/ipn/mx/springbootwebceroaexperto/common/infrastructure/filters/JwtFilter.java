...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private final HandlerExceptionResolver handlerExceptionResolver;// sirve para que las excepciones ocurridas en este filtro (dentro de doFilterInternal) al atender una peticion a una ruta protegida por ejemplo, sean manejadas por la clase que tenga la anotacion @RestControllerAdvice (que es la clase ApiExceptionHandler)
